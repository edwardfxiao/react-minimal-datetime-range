...
var CalendarPicker = (0, _react.memo)(function (_ref) {
  ...
  return _react["default"].createElement("div", {
    style: style
  }, internalShow && _react["default"].createElement(CalendarPickerComponent, {
    show: internalShow,
...
var RangePicker = (0, _react.memo)(function (_ref3) {
  ...
  var isDefaultDatesValid = (0, _react.useMemo)(function () {
    var isValid = false;

    if (defaultDates.length === 2) {
      isValid = true;
      defaultDates.forEach(function (defaultDate) {
        if (!(0, _utils.isValidDate)(defaultDate)) {
          isValid = false;
        }
      });
    }
  ...
  var handleOnConfirm = (0, _react.useCallback)(function () {
    var a = new Date(startDatePickedArray.join('-'));
    var b = new Date(endDatePickedArray.join('-'));
    var starts = a < b ? startDatePickedArray : endDatePickedArray;
    var ends = a > b ? startDatePickedArray : endDatePickedArray;
    var startStr = "".concat(starts.join('-'), " ").concat(startTimePickedArray.join(':'));
    var endStr = "".concat(ends.join('-'), " ").concat(endTimePickedArray.join(':'));
    setStart(startStr);
    setEnd(endStr);
  ...
  return _react["default"].createElement("div", {
    ...
    className: "react-minimal-datetime-range__range-input-wrapper",
    onClick: function onClick() {
      return setInternalShow(!internalShow);
    }
  }, _react["default"].createElement("input", {
    readOnly: true,
    placeholder: placeholder[0],
    className: "react-minimal-datetime-range__range-input",
    tabIndex: "-1",
    value: start
  }), _react["default"].createElement("span", {
    ...
    tabIndex: "-1",
    value: end
  }), start ? _react["default"].createElement("svg", {
    ...
    fill: "none",
    d: "M0 0h24v24H0z"
  }))), internalShow && _react["default"].createElement(RangePickerComponent, {
    show: internalShow,
    selected: selected,
...
var RangePickerComponent = (0, _react.memo)(function (_ref6) {
  ...
  return _react["default"].createElement("div", {
  ...
  }, _react["default"].createElement(_RangeDate["default"], {
    selected: selected,
    setSelected: setSelected,
    handleChooseStartDate: handleChooseStartDate,
    handleChooseEndDate: handleChooseEndDate,
    ...
    currentDateObjEnd: currentDateObjEnd,
    setCurrentDateObjEnd: setCurrentDateObjEnd
  }), type === TYPES[1] && _react["default"].createElement("div", {
    className: "react-minimal-datetime-range__time-piker"
  }, _react["default"].createElement(_RangeTime["default"], {
  ...
  }, type === TYPES[0] ? _locale["default"][locale][TYPES[1]] : _locale["default"][locale][TYPES[0]]), _react["default"].createElement("div", {
  ...
  }, _locale["default"][locale]['confirm'])));
});